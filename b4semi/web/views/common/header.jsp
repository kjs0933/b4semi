...
<% 
	...
	{ 
		cartData = cookieString.split("/");
	}
	
	if(cartData == null){ cartCount = 0; }
	else{ cartCount = cartData.length; }
%>
...
/*      장바구니에 담긴 품목 개수 출력 */
        #cart-count
        {
        	...
        	height: 11px;
        	border-radius: 50%;
        	background-color: rgba(50, 50, 75);
        	color: white;
        	display: flex;
        	align-items: center;
        	justify-content: center;
...
/* 		footer */
        ...
        .cart-msg > span{font-size: 14px;}
        .added-prod-name{font-size: 16px!important; font-weight: bold;}
        .cart-msg-container > div{padding: 20px;}
        .cart-msg-container > div:nth-of-type(1){flex: 1 1 0;}
        .cart-msg-container > div:nth-of-type(2){flex: 4 1 0;}
